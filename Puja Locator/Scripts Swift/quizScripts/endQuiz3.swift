...
class endQuiz3: UIViewController {
    ...
    func sendToDB() {
        let url = URL(string: "http://localhost/Puja%20Locator/week3Quiz.php")
        var request = URLRequest(url: url!)
        print(url)
        request.httpMethod = "POST"
        let body = "week3Score=\(score!)&emailID=\(EmailID!)&phoneNo=\(PhoneNo!)"
