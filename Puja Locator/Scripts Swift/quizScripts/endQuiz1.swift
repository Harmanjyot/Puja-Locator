...
class endQuiz1: UIViewController {
    ...
    func sendToDB() {
        let url = URL(string: "http://localhost/Puja%20Locator/week1Quiz.php")
        var request = URLRequest(url: url!)
        print(url)
        request.httpMethod = "POST"
        let body = "week1Score=\(score!)&emailID=\(EmailID!)&phoneNo=\(PhoneNo!)"
