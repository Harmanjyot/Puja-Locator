...
class endQuiz4: UIViewController {
    ...
    func sendToDB() {
        let url = URL(string: "http://localhost/Puja%20Locator/week4Quiz.php")
        var request = URLRequest(url: url!)
        print(url)
        request.httpMethod = "POST"
        let body = "week4Score=\(score!)&emailID=\(EmailID!)&phoneNo=\(PhoneNo!)"
